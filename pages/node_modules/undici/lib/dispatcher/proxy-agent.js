...
const Pool = require('undici/lib/dispatcher/pool')
const DispatcherBase = require('undici/lib/dispatcher/dispatcher-base')
const { InvalidArgumentError, RequestAbortedError, SecureProxyConnectionError } = require('undici/lib/core/errors')
...
class ProxyAgent extends DispatcherBase {
  ...
  /**
   * @param {import('undici/lib/types/proxy-agent').ProxyAgent.Options | string | URL} opts
   * @returns {URL}
   */
  #getUrl (opts) {
